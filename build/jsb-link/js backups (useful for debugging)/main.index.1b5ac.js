...
1: [ function(e, t) {
var n = e("util/"), i = Array.prototype.slice, o = Object.prototype.hasOwnProperty, c = t.exports = u;
...
function a(e) {
return r(JSON.stringify(e.actual, s), 128) + " " + e.operator + " " + r(JSON.stringify(e.expected, s), 128);
}
...
d(e, t) || l(e, t, n, "deepEqual", c.deepEqual);
};
function d(e, t) {
if (e === t) return !0;
...
var o = f(e), c = f(t);
if (o && !c || !o && c) return !1;
if (o) return d(e = i.call(e), t = i.call(t));
var s, r, a = m(e), l = m(t);
if (a.length != l.length) return !1;
a.sort();
l.sort();
for (r = a.length - 1; r >= 0; r--) if (a[r] != l[r]) return !1;
for (r = a.length - 1; r >= 0; r--) if (!d(e[s = a[r]], t[s])) return !1;
return !0;
}
c.notDeepEqual = function(e, t, n) {
d(e, t) && l(e, t, n, "notDeepEqual", c.notDeepEqual);
};
...
n = 1;
for (var i = arguments, c = i.length, s = String(e).replace(o, function(e) {
if ("%%" === e) return "%";
if (n >= c) return e;
switch (e) {
case "%s":
...
}), a = i[n]; n < c; a = i[++n]) _(a) || !R(a) ? s += " " + a : s += " " + r(a);
return s;
};
...
S(c) && (c = t.env.NODE_DEBUG || "");
e = e.toUpperCase();
if (!s[e]) if (new RegExp("\\b" + e + "\\b", "i").test(c)) {
var i = t.pid;
s[e] = function() {
...
var c = f(e, t);
if (c) return c;
var s = Object.keys(t), r = u(s);
e.showHidden && (s = Object.getOwnPropertyNames(t));
if (x(t) && (s.indexOf("message") >= 0 || s.indexOf("description") >= 0)) return h(t);
if (0 === s.length) {
if (I(t)) {
var a = t.name ? ": " + t.name : "";
...
return w(t) ? e.stylize("" + t, "number") : y(t) ? e.stylize("" + t, "boolean") : _(t) ? e.stylize("null", "null") : void 0;
}
function h(e) {
return "[" + Error.prototype.toString.call(e) + "]";
}
function p(e, t, n, i, o) {
for (var c = [], s = 0, r = t.length; s < r; ++s) L(t, String(s)) ? c.push(g(e, t, n, i, String(s), !0)) : c.push("");
...
value: t[o]
}).get ? r = a.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : a.set && (r = e.stylize("[Setter]", "special"));
L(i, o) || (s = "[" + o + "]");
r || (e.seen.indexOf(a.value) < 0 ? (r = _(n) ? d(e, a.value, null) : d(e, a.value, n - 1)).indexOf("\n") > -1 && (r = c ? r.split("\n").map(function(e) {
return "  " + e;
}).join("\n").substr(2) : "\n" + r.split("\n").map(function(e) {
return "   " + e;
}).join("\n")) : r = e.stylize("[Circular]", "special"));
if (S(s)) {
if (c && o.match(/^\d+$/)) return r;
...
n.isObject = R;
function k(e) {
return R(e) && "[object Date]" === E(e);
}
n.isDate = k;
function x(e) {
return R(e) && ("[object Error]" === E(e) || e instanceof Error);
}
n.isError = x;
function I(e) {
...
function O() {
var e = new Date(), t = [ F(e.getHours()), F(e.getMinutes()), F(e.getSeconds()) ].join(":");
...
cc.utils.net.addHandler("exit_result", function(t) {
e.dispatchEvent("exit_result", t);
});
cc.utils.net.addHandler("disconnect", function(t) {
e.dispatchEvent("disconnect", t);
});
cc.utils.net.addHandler("new_player_entered_room", function(t) {
e.dispatchEvent("new_player_entered_room", t);
});
cc.utils.net.addHandler("other_player_exit", function(t) {
e.dispatchEvent("other_player_exit", t);
});
},
...
n.sendRequest = function e(t, i, o, c, s, r) {
void 0 === s && (s = !1);
void 0 === r && (r = null);
...
var f = c + l + encodeURI(u);
console.log("RequestURL:" + f);
a.open("GET", f, !0);
...
cc.log("request from [" + a.responseURL + "] data [", t, "]");
var e = a.responseText, t = null;
try {
t = JSON.parse(e);
} catch (e) {
console.log("err:" + e);
...
console.log("other readystate == 4, status:" + a.status);
setTimeout(function() {
p();
}, 5e3);
} else console.log("other readystate:" + a.readyState + ", status:" + a.status);
};
try {
a.send();
} catch (e) {
...
cc.utils.userInfo.token = e.token;
cc.utils.userInfo.nickname = e.nickname;
cc.director.loadScene("RoomChoice");
}
});
},
...
setSeatInfo: function(e, t, n, i, o, c) {
void 0 === n && (n = "");
void 0 === i && (i = 0);
void 0 === o && (o = 0);
void 0 === c && (c = !0);
if (t) {
console.log("empty seat, ", e);
this.seats[e].icon.spriteFrame = this.seatNobodyIcon;
this.seats[e].ready.active = !1;
this.seats[e].offline.active = !1;
} else {
this.seats[e].icon.spriteFrame = this.seatIcon;
this.seats[e].ready.active = !0;
this.seats[e].offline.active = !c;
}
this.seats[e].name.string = n;
this.seats[e].xi.string = i.toString();
this.seats[e].score.string = o.toString();
},
initSeatView: function() {
console.log("initSeatView was called!!!");
this.seats = [];
for (var e = 1; e < 4; ++e) this.seats.push({
icon: cc.find("Canvas/Players/seat" + e.toString() + "/PlayerIcon").getComponent(cc.Sprite),
offline: cc.find("Canvas/Players/seat" + e.toString() + "/offline"),
name: cc.find("Canvas/Players/seat" + e.toString() + "/nameLabel").getComponent(cc.Label),
score: cc.find("Canvas/Players/seat" + e.toString() + "/scoreLabel").getComponent(cc.Label),
xi: cc.find("Canvas/Players/seat" + e.toString() + "/xi/xiLabel").getComponent(cc.Label),
ready: cc.find("Canvas/Players/seat" + e.toString() + "/ready")
});
this.seatNobodyIcon = this.seats[1].icon.spriteFrame;
this.seatIcon = this.seats[0].icon.spriteFrame;
this.setSeatInfo(1, !1, cc.utils.userInfo.nickname, 0, 0, !0);
this.nextPlayerId = cc.utils.roomInfo.my_seat_id + 1;
this.nextPlayerId >= 3 && (this.nextPlayerId = 0);
this.prevPlayerId = cc.utils.roomInfo.my_seat_id - 1;
this.prevPlayerId < 0 && (this.prevPlayerId = 2);
this.setSeatInfo(2, !0);
this.setSeatInfo(0, !0);
for (var t = 0; t < cc.utils.roomInfo.other_players.length; ++t) {
var n = cc.utils.roomInfo.other_players[t];
n.seat_id === this.nextPlayerId ? this.setSeatInfo(2, !1, n.nickname, 0, 0, !0) : this.setSeatInfo(0, !1, n.nickname, 0, 0, !0);
}
},
initEventHandlers: function() {
cc.utils.gameNetworkingManager.dataEventHandler = this.node;
this.node.on("exit_result", function(e) {
console.log("exit_result arrived");
if (0 === e.errcode) {
cc.utils.net.close();
cc.utils.roomInfo = null;
} else cc.utils.wc.hide();
});
this.node.on("disconnect", function() {
console.log("disconnect arrived");
cc.director.loadScene("RoomChoice");
});
this.node.on("new_player_entered_room", function(e) {
e.seat_id === this.nextPlayerId ? this.setSeatInfo(2, !1, e.nickname, 0, e.score, e.online) : this.setSeatInfo(0, !1, e.nickname, 0, e.score, e.online);
}.bind(this));
this.node.on("other_player_exit", function(e) {
console.log("other_player_exit", e);
e.seat_id === this.nextPlayerId ? this.setSeatInfo(2, !0) : this.setSeatInfo(0, !0);
}.bind(this));
},
...
cc.utils.roomInfo = {
room_id: e.room_id,
my_seat_id: e.seat_id,
other_players: e.other_players
};
cc.utils.wc.hide();
