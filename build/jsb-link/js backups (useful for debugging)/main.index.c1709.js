...
u.sort();
l.sort();
for (r = u.length - 1; r >= 0; r--) if (u[r] != l[r]) return !1;
for (r = u.length - 1; r >= 0; r--) if (!f(e[s = u[r]], t[s])) return !1;
return !0;
}
...
}), u = i[n]; n < c; u = i[++n]) w(u) || !S(u) ? s += " " + u : s += " " + r(u);
return s;
};
...
var c = d(e, t);
if (c) return c;
var s = Object.keys(t), r = a(s);
e.showHidden && (s = Object.getOwnPropertyNames(t));
if (E(t) && (s.indexOf("message") >= 0 || s.indexOf("description") >= 0)) return h(t);
if (0 === s.length) {
if (x(t)) {
var u = t.name ? ": " + t.name : "";
...
E(t) && (y = " " + h(t));
if (0 === s.length && (!w || 0 == t.length)) return _[0] + y + _[1];
if (i < 0) return C(t) ? e.stylize(RegExp.prototype.toString.call(t), "regexp") : e.stylize("[Object]", "special");
e.seen.push(t);
l = w ? p(e, t, i, r, s) : s.map(function(n) {
return g(e, t, i, r, n, w);
});
e.seen.pop();
return m(l, y, _);
}
...
for (var c = [], s = 0, r = t.length; s < r; ++s) T(t, String(s)) ? c.push(g(e, t, n, i, String(s), !0)) : c.push("");
...
value: t[o]
}).get ? r = u.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : u.set && (r = e.stylize("[Setter]", "special"));
T(i, o) || (s = "[" + o + "]");
r || (e.seen.indexOf(u.value) < 0 ? (r = w(n) ? f(e, u.value, null) : f(e, u.value, n - 1)).indexOf("\n") > -1 && (r = c ? r.split("\n").map(function(e) {
return "  " + e;
}).join("\n").substr(2) : "\n" + r.split("\n").map(function(e) {
return "   " + e;
...
this.sio.on("goodtogo", function(n) {
console.log("this.sio.on('connect'");
t.sio.connected = !0;
e(n);
});
...
send: function(e, t) {
console.log("sio send", e, t, this.sio.connected);
