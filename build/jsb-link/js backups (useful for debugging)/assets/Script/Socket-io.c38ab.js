...
n = a(s, e)) : (p[u] || (c("new io instance for %s", s), p[u] = a(s, e)), n = p[u]), 
...
"use strict";
var r = n(2), o = n(3)("socket.io-client:url");
...
var i = 1e3, s = 60 * i, a = 60 * s, c = 24 * a, p = 365.25 * c;
...
} else if (i(o)) for (var f = 0; f < o.length; f++) t(o[f], f, o); else if ("object" == typeof o && !s(o)) for (var l in o) t(o[l], l, o);
})(r), n || e(r);
};
}, function(t) {
var e = {}.toString;
...
t.exports = function(t) {
return e && Buffer.isBuffer(t) || n && (t instanceof ArrayBuffer || r(t));
};
var e = "function" == typeof Buffer && "function" == typeof Buffer.isBuffer, n = "function" == typeof ArrayBuffer, r = function(t) {
...
h("connect attempt timed out after %d", s), r.destroy(), e.close(), e.emit("error", "timeout"), 
...
t ? (t = u(t), e.hostname = t.host, e.secure = "https" === t.protocol || "wss" === t.protocol, 
...
var r = n(16), o = n(18), i = n(32), s = n(33);
...
s.decodePayload(t, this.socket.binaryType, function(t) {
...
o[0] = v[t.type];
return r(new k([ o.buffer, t.data ]));
}
function a(t) {
try {
t = d.decode(t, {
...
u = "";
for (p = 0; p < h.length; p++) u += String.fromCharCode(h[p]);
}
i.push(u), o = f(o, c);
}
var l = i.length;
...
var r = n(10), o = Object.prototype.toString, i = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === o.call(Blob), s = "function" == typeof File || "undefined" != typeof File && "[object FileConstructor]" === o.call(File);
t.exports = function t(e) {
...
function n(t) {
for (var e, n = t.length, r = -1, o = ""; ++r < n; ) (e = t[r]) > 65535 && (o += h((e -= 65536) >>> 10 & 1023 | 55296), 
e = 56320 | 1023 & e), o += h(e);
return o;
}
function r(t, e) {
if (t >= 55296 && t <= 57343) {
...
n = h(t >> 12 & 15 | 224), n += o(t, 6)) : 0 == (4292870144 & t) && (n = h(t >> 18 & 7 | 240), 
n += o(t, 12), n += o(t, 6)), n + h(63 & t | 128);
}
function s() {
...
version: "2.1.2",
encode: function(t, n) {
for (var r = !1 !== (n = n || {}).strict, o = e(t), s = o.length, a = -1, c = ""; ++a < s; ) c += i(o[a], r);
return c;
},
decode: function(t, r) {
var o = !1 !== (r = r || {}).strict;
c = e(t), p = c.length, u = 0;
for (var i, s = []; !1 !== (i = a(o)); ) s.push(i);
return n(s);
}
};
}, function(t, e) {
...
function r(t, n) {
return new Blob(e(t), n || {});
}
var o = "undefined" != typeof o ? o : "undefined" != typeof WebKitBlobBuilder ? WebKitBlobBuilder : "undefined" != typeof MSBlobBuilder ? MSBlobBuilder : "undefined" != typeof MozBlobBuilder && MozBlobBuilder, i = function() {
try {
...
"undefined" != typeof Blob && (n.prototype = Blob.prototype, r.prototype = Blob.prototype), 
t.exports = i ? s ? Blob : r : a ? n : void 0;
}, function(t, e) {
e.encode = function(t) {
var e = "";
...
this.usingBrowserWebSocket = o && !t.forceNode, this.protocols = t.protocols, this.usingBrowserWebSocket || (f = i), 
s.call(this, t);
}
...
var o = {};
(t.options && (o.compress = t.options.compress), e.perMessageDeflate) && ("string" == typeof r ? Buffer.byteLength(r) : r.length) < e.perMessageDeflate.threshold && (o.compress = !1);
}
try {
