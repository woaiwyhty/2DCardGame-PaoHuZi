...
1: [ function(e, t) {
var n = e("util/"), i = Array.prototype.slice, o = Object.prototype.hasOwnProperty, c = t.exports = l;
...
e == t && a(e, t, n, "!=", c.notEqual);
};
c.deepEqual = function(e, t, n) {
f(e, t) || a(e, t, n, "deepEqual", c.deepEqual);
};
function f(e, t) {
if (e === t) return !0;
...
f(e, t) && a(e, t, n, "notDeepEqual", c.notDeepEqual);
};
c.strictEqual = function(e, t, n) {
e !== t && a(e, t, n, "===", c.strictEqual);
};
c.notStrictEqual = function(e, t, n) {
e === t && a(e, t, n, "!==", c.notStrictEqual);
};
function p(e, t) {
...
e && !c && a(c, i, "Missing expected exception" + o);
!e && p(c, i) && a(c, i, "Got unwanted exception" + o);
...
e.seen.push(t);
a = w ? p(e, t, i, s, r) : r.map(function(n) {
...
setInterval(function() {
e.sio && Date.now() - e.lastRecieveTime > 1e4 && e.close();
}.bind(this), 500);
}
},
send: function(e, t) {
